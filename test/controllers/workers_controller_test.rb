...
class WorkersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create worker" do
    assert_difference('Worker.count') do
      post workers_url, params: { worker: { address: @worker.address, name: @worker.name, phone: @worker.phone } }
    end
  ...
  test "should update worker" do
    patch worker_url(@worker), params: { worker: { address: @worker.address, name: @worker.name, phone: @worker.phone } }
